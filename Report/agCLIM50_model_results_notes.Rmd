...
## GDP, POP and YEXO
These are the three key exogenous drivers and are supposed to be the same (overlapping lines) across models. Nevertheless, the figures show (minor) differences. *POPT* seems consistent but *GDPT* shows large differences for a number of regions. Also *YEXO* shows considerable differences across models.
