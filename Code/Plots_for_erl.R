...
# LOAD DATA
#TOTAL_raw <- read.csv(file.path(dataPath, "ModelResults/TOTAL_2017-10-31.csv")) # ERL Submitted paper
TOTAL_raw <- read.csv(file.path(dataPath, "ModelResults/TOTAL_2018-02-28.csv")) # MAGNET rcp2p6 scenario added
