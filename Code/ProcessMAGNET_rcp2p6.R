...
### PACKAGES
BasePackages <- c("readr", "lazyeval", "foreign", "stringr", "zoo", "tidyr", "RColorBrewer", "plyr", "dplyr", "ggplot2", "haven")
...
### Set working folder
wdPath <- "D:\\Jason\\AgCLim50_2_27_18"
setwd(wdPath)  
...
write_csv(MAGNET_tot, file.path(agCLIM50Path, paste("agclim50_MAGNET_rcp2p6_", Sys.Date(), ".csv", sep="")))
